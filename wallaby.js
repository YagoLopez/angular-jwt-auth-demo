...
module.exports = function (wallaby) {
  ...
  var webpackPostprocessor = wallabyWebpack({
    entryPatterns: [
      'src/wallabyTest.js',
      'src/**/*spec.js'
      // 'projects/angular-jwt-auth/src/**/*spec.js'
    ],
    ...
    resolve: {
      ...
      modules: [
        ...
        // path.join(wallaby.projectCacheDir, 'projects/angular-jwt-auth/src'),
        'node_modules'
      ]
    },
    node: {
  ...
  return {
    files: [
      ...
      // {pattern: 'projects/angular-jwt-auth/src/lib/**/wallabyTest.ts', ignore: false}
      // {pattern: 'projects/angular-jwt-auth/src/**/*spec.ts', ignore: true}
    ],
    tests: [
      {pattern: 'src/**/*spec.ts', load: false},
      {pattern: 'src/**/*e2e-spec.ts', ignore: true}
      // {pattern: 'projects/angular-jwt-auth/src/**/*spec.ts', load: false}
    ],
